...
export class TelemetryClient implements ITelemetryClient {
  ...
  constructor(apiUrl: string, publicKey: string, sessionId: string, maxRetries = 3, logger?: Logger) {
  ...
  public async sendBatch(batch: TelemetryBatch): Promise<TransportResponse> {
  ...
  public sendBeacon(batch: TelemetryBatch): boolean {
