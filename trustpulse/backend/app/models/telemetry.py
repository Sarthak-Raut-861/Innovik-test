...
from sqlalchemy import String, DateTime, Integer, BigInteger, JSON, Index
...
class TelemetryEventModel(Base):
    ...
    __table_args__ = (
        Index("ix_telemetry_tenant_session_seq", "customer_tenant_id", "session_id", "sequence_number"),
