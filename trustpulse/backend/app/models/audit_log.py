...
class AuditLogModel(Base):
    ...
    actor_type: Mapped[str] = mapped_column(String(32), default="SYSTEM", nullable=False)  # SYSTEM, API_CLIENT, SEC_ANALYST
    actor_id: Mapped[Optional[str]] = mapped_column(String(128), nullable=True)
    event_type: Mapped[str] = mapped_column(String(64), nullable=False)  # SESSION_CREATED, RISK_EVALUATED, etc.
